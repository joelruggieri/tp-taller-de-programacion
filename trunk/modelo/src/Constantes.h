...
#define LONGITUD_CINTA 20.0
#define RADIO_EJE_CINTA 3.0
#define RADIO_ENGRANAJE 4.8
#define CATEGORIA_FIGURAS 0X0002
#define CATEGORIA_CORREA 0X0006
#define CATEGORIA_RANGO_ENGRANAJE 0X0004
#define RADIO_ENGRANAJE_CHICO 4.8
#define RADIO_ENGRANAJE_MEDIO 7.5
#define RADIO_ENGRANAJE_GRANDE 10
//#define
//#define
//#define
//#define
