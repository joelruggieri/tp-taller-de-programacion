...
private:
	...
	void obtenerPoleas(std::list<Figura*> &lista, YAML::Node objetos);
	void obtenerBombas(std::list<Figura*> &lista, YAML::Node objetos);
	void obtenerControles(std::list<Figura*> &lista, YAML::Node objetos);
